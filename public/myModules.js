...
function getWeather(latitude,longitude) {
	if(latitude != '' && longitude != '') {
		...
		$.getJSON( "http://api.openweathermap.org/data/2.5/weather?lat="+latitude+"&lon="+longitude+"&APPID=<API-KEY>&units=metric", function(data) {	// add '&units=imperial' to get U.S. measurements
